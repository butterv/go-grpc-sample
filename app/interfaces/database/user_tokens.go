...
func (q userTokenQuery) One(ctx context.Context, exec boil.ContextExecutor) (*UserToken, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "database: failed to execute a one query for user_tokens")
	}
...
func (q userTokenQuery) All(ctx context.Context, exec boil.ContextExecutor) (UserTokenSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "database: failed to assign all query results to UserToken slice")
	}
...
func (q userTokenQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "database: failed to count user_tokens rows")
	}
...
func (q userTokenQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "database: failed to check if user_tokens exists")
	}
...
func FindUserToken(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*UserToken, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "database: unable to select from user_tokens")
	}
...
func (o *UserToken) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("database: no user_tokens provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "database: unable to insert into user_tokens")
	}
	...
	if err != nil {
		return errors.Wrap(err, "database: unable to populate default values for user_tokens")
	}
...
func (o *UserToken) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("database: unable to update user_tokens, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "database: unable to update user_tokens row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "database: failed to get rows affected by update for user_tokens")
	}
...
func (q userTokenQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "database: unable to update all for user_tokens")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "database: unable to retrieve rows affected for user_tokens")
	}
...
func (o UserTokenSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "database: unable to update all in userToken slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "database: unable to retrieve rows affected all in update all userToken")
	}
	return rowsAff, nil
}
...
func (o *UserToken) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("database: no user_tokens provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("database: unable to upsert user_tokens, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "database: unable to upsert for user_tokens")
	}
	...
	if err != nil {
		return errors.Wrap(err, "database: unable to retrieve unique values for user_tokens")
	}
...
func (o *UserToken) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("database: no UserToken provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "database: unable to delete from user_tokens")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "database: failed to get rows affected by delete for user_tokens")
	}
...
func (q userTokenQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("database: no userTokenQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "database: unable to delete all from user_tokens")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "database: failed to get rows affected by deleteall for user_tokens")
	}
...
func (o UserTokenSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "database: unable to delete all from userToken slice")
	}
...
func (o *UserToken) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("database: no UserToken provided for reload")
	}
...
func (o *UserTokenSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("database: empty UserTokenSlice provided for reload all")
	}
...
func (o *UserTokenSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "database: unable to reload all in UserTokenSlice")
	}
...
func UserTokenExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "database: unable to check if user_tokens exists")
	}
