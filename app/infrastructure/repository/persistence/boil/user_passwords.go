...
func (q userPasswordQuery) One(ctx context.Context, exec boil.ContextExecutor) (*UserPassword, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "boil: failed to execute a one query for user_passwords")
	}
...
func (q userPasswordQuery) All(ctx context.Context, exec boil.ContextExecutor) (UserPasswordSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "boil: failed to assign all query results to UserPassword slice")
	}
...
func (q userPasswordQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boil: failed to count user_passwords rows")
	}
...
func (q userPasswordQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "boil: failed to check if user_passwords exists")
	}
...
func FindUserPassword(ctx context.Context, exec boil.ContextExecutor, userID string, selectCols ...string) (*UserPassword, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "boil: unable to select from user_passwords")
	}
...
func (o *UserPassword) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("boil: no user_passwords provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "boil: unable to insert into user_passwords")
	}
	...
	if err != nil {
		return errors.Wrap(err, "boil: unable to populate default values for user_passwords")
	}
...
func (o *UserPassword) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("boil: unable to update user_passwords, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "boil: unable to update user_passwords row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boil: failed to get rows affected by update for user_passwords")
	}
...
func (q userPasswordQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boil: unable to update all for user_passwords")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boil: unable to retrieve rows affected for user_passwords")
	}
...
func (o UserPasswordSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boil: unable to update all in userPassword slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boil: unable to retrieve rows affected all in update all userPassword")
	}
	return rowsAff, nil
}
...
func (o *UserPassword) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("boil: no user_passwords provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("boil: unable to upsert user_passwords, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "boil: unable to upsert for user_passwords")
	}
	...
	if err != nil {
		return errors.Wrap(err, "boil: unable to retrieve unique values for user_passwords")
	}
...
func (o *UserPassword) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("boil: no UserPassword provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "boil: unable to delete from user_passwords")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boil: failed to get rows affected by delete for user_passwords")
	}
...
func (q userPasswordQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("boil: no userPasswordQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "boil: unable to delete all from user_passwords")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boil: failed to get rows affected by deleteall for user_passwords")
	}
...
func (o UserPasswordSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "boil: unable to delete all from userPassword slice")
	}
...
func (o *UserPassword) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("boil: no UserPassword provided for reload")
	}
...
func (o *UserPasswordSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("boil: empty UserPasswordSlice provided for reload all")
	}
...
func (o *UserPasswordSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "boil: unable to reload all in UserPasswordSlice")
	}
...
func UserPasswordExists(ctx context.Context, exec boil.ContextExecutor, userID string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "boil: unable to check if user_passwords exists")
	}
