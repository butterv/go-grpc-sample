...
func (q userQuery) One(ctx context.Context, exec boil.ContextExecutor) (*User, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "boil: failed to execute a one query for users")
	}
...
func (q userQuery) All(ctx context.Context, exec boil.ContextExecutor) (UserSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "boil: failed to assign all query results to User slice")
	}
...
func (q userQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boil: failed to count users rows")
	}
...
func (q userQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "boil: failed to check if users exists")
	}
...
func (o *User) UserPassword(mods ...qm.QueryMod) userPasswordQuery {
	...
	query := UserPasswords(queryMods...)
	queries.SetFrom(query.Query, "`user_passwords`")
...
func (userL) LoadUserPassword(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(qm.From(`user_passwords`), qm.WhereIn(`user_passwords.user_id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
...
// SetUserPasswordG of the user to the related item.
// Sets o.R.UserPassword to related.
// Adds o to related.R.User.
// Uses the global database handle.
func (o *User) SetUserPasswordG(ctx context.Context, insert bool, related *UserPassword) error {
	return o.SetUserPassword(ctx, boil.GetContextDB(), insert, related)
}

// SetUserPasswordP of the user to the related item.
// Sets o.R.UserPassword to related.
// Adds o to related.R.User.
// Panics on error.
func (o *User) SetUserPasswordP(ctx context.Context, exec boil.ContextExecutor, insert bool, related *UserPassword) {
	if err := o.SetUserPassword(ctx, exec, insert, related); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetUserPasswordGP of the user to the related item.
// Sets o.R.UserPassword to related.
// Adds o to related.R.User.
// Uses the global database handle and panics on error.
func (o *User) SetUserPasswordGP(ctx context.Context, insert bool, related *UserPassword) {
	if err := o.SetUserPassword(ctx, boil.GetContextDB(), insert, related); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
// Uses the global database handle.
func (o *User) AddUserTokensG(ctx context.Context, insert bool, related ...*UserToken) error {
	return o.AddUserTokens(ctx, boil.GetContextDB(), insert, related...)
}
...
// Sets related.R.User appropriately.
// Panics on error.
func (o *User) AddUserTokensP(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UserToken) {
	if err := o.AddUserTokens(ctx, exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
// Sets related.R.User appropriately.
// Uses the global database handle and panics on error.
func (o *User) AddUserTokensGP(ctx context.Context, insert bool, related ...*UserToken) {
	if err := o.AddUserTokens(ctx, boil.GetContextDB(), insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
func FindUser(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*User, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "boil: unable to select from users")
	}
...
func (o *User) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("boil: no users provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "boil: unable to insert into users")
	}
	...
	if err != nil {
		return errors.Wrap(err, "boil: unable to populate default values for users")
	}
...
func (o *User) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("boil: unable to update users, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "boil: unable to update users row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boil: failed to get rows affected by update for users")
	}
...
func (q userQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boil: unable to update all for users")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boil: unable to retrieve rows affected for users")
	}
...
func (o UserSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boil: unable to update all in user slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boil: unable to retrieve rows affected all in update all user")
	}
	return rowsAff, nil
}
...
func (o *User) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("boil: no users provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("boil: unable to upsert users, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "boil: unable to upsert for users")
	}
	...
	if err != nil {
		return errors.Wrap(err, "boil: unable to retrieve unique values for users")
	}
...
func (o *User) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("boil: no User provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "boil: unable to delete from users")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boil: failed to get rows affected by delete for users")
	}
...
func (q userQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("boil: no userQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "boil: unable to delete all from users")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boil: failed to get rows affected by deleteall for users")
	}
...
func (o UserSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "boil: unable to delete all from user slice")
	}
...
func (o *User) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("boil: no User provided for reload")
	}
...
func (o *UserSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("boil: empty UserSlice provided for reload all")
	}
...
func (o *UserSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "boil: unable to reload all in UserSlice")
	}
...
func UserExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "boil: unable to check if users exists")
	}
